...
module.exports={
  //获取Banner
  getBanner : function(){
    var imgList = ["./src/assets/img/index-banner1.jpg","./src/assets/img/index-banner2.jpg","./src/assets/img/index-banner3.jpg","./src/assets/img/index-banner4.jpg","./src/assets/img/index-banner5.jpg","./src/assets/img/index-banner6.jpg","./src/assets/img/index-banner7.jpg"]
    return imgList
  },
  getNav : function(){
    var imgNav = {
